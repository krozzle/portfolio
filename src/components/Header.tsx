const Header = () => (
  <div className="flex justify-around items-center py-4 text-md text-gray-900 font-hairline bg-opacity-50 lg:opacity-25 lg:transition lg:duration-500 lg:hover:ease-in-out lg:hover:opacity-100 bg-gray-500 lg:hover:bg-opacity-50 top-0 sticky">
      ...
      <div>
        <div>
          <div className="">
            ...
            <a href="/#getInTouch" className="px-2">
              contact
            </a>
