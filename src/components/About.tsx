...
const About = () => (
  <Fade>
    <div id="about" className="bg-gray-100 text-gray-900 ">
      <div className="lg:w-2/3 flex flex-col-reverse lg:flex-row justify-center lg:justify-start items-center lg:px-32 2xl:px-48 py-24 lg:pt-48 tracking-wide leading-relaxed text-2xl text-center lg:text-left">
        ...
        <div className="lg:w-1/2 flex-col justify-center items-center lg:items-start px-12">
          <h1>About Me</h1>
          <p>
