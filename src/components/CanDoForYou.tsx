const CanDoForYou = () => (
  <div
    id="canDoForYou"
    className="flex flex-col lg:flex-row items-center justify-center lg:justify-around min-h-screen bg-teal-600 py-12"
  >
    <div className="lg:w-1/3 py-12">
      <p className="px-12 py-1 lg:py-20 uppercase border-b-2 lg:border-r-2  border-gray-500 text-gray-300 text-4xl text-center xl:text-5xl lg:text-right font-extrabold">
